Data downloaded from [Wikidata][] is under [the Creative Commons CC0 License][CC0]: see [Wikidata:Copyright][]. This data is located in the directory `docs/thirdparty/wikidata/`.
